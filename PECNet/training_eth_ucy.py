...
train_dataset = SocialDatasetETHUCY(set_name="univ", set_type='train', b_size=hyper_params["train_b_size"], t_tresh=hyper_params["time_thresh"], d_tresh=hyper_params["dist_thresh"])
test_dataset = SocialDatasetETHUCY(set_name="univ", set_type='test', b_size=hyper_params["test_b_size"], t_tresh=hyper_params["time_thresh"], d_tresh=hyper_params["dist_thresh"])
